...
public class ImageResizer {
     ...
     */
    private static File saveImage(Bitmap bitmap, String outputPath,
     ...
     */
    public static File createResizedImage(Context context, Uri imageUri, String outputPath,
                                          int newWidth,
        ...
        File newFile = ImageResizer.saveImage(scaledImage, outputPath, compressFormat, quality);
